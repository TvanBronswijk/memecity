...
private:
	...
	memecity::engine::state::StateMachine& state_machine;
...
public:
	...
	InputSystem(memecity::engine::InputManager& input_manager, memecity::engine::state::StateMachine& state_machine)
