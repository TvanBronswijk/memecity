...
public:
	...
	public:
		GameContext(memecity::engine::MultimediaManager& mm, memecity::engine::InputManager& im, memecity::engine::sdl::TimerFacade& t, memecity::engine::state::StateManager& sm, memecity::engine::StorageManager& stm)
			: Context(mm, im, t, stm), state_manager(&sm) {}
