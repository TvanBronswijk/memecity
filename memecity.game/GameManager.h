...
public:
	...
	public:
		GameContext(memecity::engine::MultimediaManager& mm, memecity::engine::InputManager& im, memecity::engine::sdl::TimerFacade& t, memecity::engine::state::StateManager& sm, QuadTree& quad_tree)
			: Context(mm, im, t, quad_tree), state_manager(&sm) {}
