...
{
	float x, y;
	VelocityComponent(memecity::engine::ecs::Entity& entity) : VelocityComponent(entity, 0.0f, 0.0f) {};
	VelocityComponent(memecity::engine::ecs::Entity& entity, float x, float y) 
