...
struct QuestAIComponent : public memecity::engine::ecs::Component {
	...
	QuestAIComponent(memecity::engine::ecs::Entity& entity, std::string name , std::unique_ptr<memecity::engine::texture::TextTexture> texture) : memecity::engine::ecs::Component(entity), name(name) , texture(std::move(texture)), state(State::Idle) {};
