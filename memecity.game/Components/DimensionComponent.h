...
struct DimensionComponent : public memecity::engine::ecs::Component
{
	...
	DimensionComponent(const memecity::engine::ecs::Entity& entity) : DimensionComponent(entity, 0, 0) {};
	DimensionComponent(const memecity::engine::ecs::Entity& entity, float w, float h)
