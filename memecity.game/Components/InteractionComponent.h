...
public:
	...
	InteractionComponent(memecity::engine::ecs::Entity& entity) : InteractionComponent(entity, nullptr) {};
	InteractionComponent(memecity::engine::ecs::Entity& entity, std::unique_ptr<memecity::engine::texture::Texture> texture) : 
		InteractionComponent(entity,{ "Hello Stranger!", "Sorry, i can't talk now.", "what are you doing?" }, std::move(texture)) {};
	InteractionComponent(memecity::engine::ecs::Entity& entity, std::vector<std::string> smallTalk, std::unique_ptr<memecity::engine::texture::Texture> texture) 
