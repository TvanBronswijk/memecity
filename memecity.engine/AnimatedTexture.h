...
public:	
	...
	:  Texture(filename, x, y, w, h), timer_facade(timer_facade), animation_direction(direction), start_x(x), start_y(y), frame_count(frame_count), animation_speed(animation_speed), time_per_frame(animation_speed / frame_count)
	{};
